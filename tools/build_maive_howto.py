...
<p>Using an AI assistant? Attach your spreadsheet and say: "Run MAIVE on this dataset,
following the protocol at https://meta-analysis.cz/maive/how-to/#ai." If your assistant
cannot read links, open the block below and paste the protocol instead.</p>
