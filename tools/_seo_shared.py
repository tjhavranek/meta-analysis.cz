...
SELF_MANAGED = {
    ...
    "ai",          # hand-authored, noindex question page (pilot); web_meta/ask_worker answers
                   ...
                   # would be fabricated.
    "teaching",    # the teaching hub and course pages. Their generator lives outside this
                   # repository (web_meta/ask_worker/site_pages/make_teaching_pages.py), because
                   # it reads the private course folders; the committed HTML is what is
                   # published, and verify_seo checks it. Courses and slide
