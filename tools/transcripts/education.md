...
Notes: The figure depicts a common metric (partial correlation coefficient) of the reported effect of tuition fees on enrolment in higher education institutions. The time trend is not statistically significant.
...
FIGURE 2. Histogram of the partial correlation coefficients.
Notes: The figure depicts a histogram of the partial correlation coefficients of the enrolment–tuition nexus estimates reported by individual studies. The dashed vertical line denotes the sample median, and the solid vertical line denotes the sample mean.
