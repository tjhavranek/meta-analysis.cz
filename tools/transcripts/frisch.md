...
FIGURE 1. Estimates are most commonly around 0.4. *Notes:* The solid line denotes the sample mean (0.48); the dashed line denotes the sample median (0.35). Estimates smaller than −1 and larger than 3 are excluded from the figure for ease of exposition but included in all tests.
...
FIGURE 4. Publication bias is driven by selection for positive sign, not significance.
...
FIGURE 5. Correlations among explanatory variables are modest. (For interpretation of the colors in the figure(s), the reader is referred to the web version of this article.)
Notes: The figure shows Pearson correlation coefficients for the variables described in Table 4.
...
FIGURE 7. Posterior inclusion probabilities hold across different priors.
