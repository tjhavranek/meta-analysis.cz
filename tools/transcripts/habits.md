...
Notes: The figure shows simulated impulse responses of GDP to a one-percentage-point increase in the monetary policy rate. We use a calibrated version of the model developed by Smets and Wouters (2007) and vary the value of the habit formation parameter while leaving all other parameters calibrated at the posterior values from Smets and Wouters (2007). For the simulations we use Matlab code from the Macro-economic Model Data Base (Wieland et al., 2012).
...
FIGURE 2. Estimates of habit formation vary widely.
...
Notes: A description of the variables is available in Table 3.
...
FIGURE A3. Funnel plots suggest little publication bias.
