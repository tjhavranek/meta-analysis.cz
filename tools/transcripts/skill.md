...
Note: Details on each variable, including definition, summary statistics, and motivation for inclusion, are available in table D1 and appendix D in the online appendix. In data collection we follow the guidelines compiled by the Meta-Analysis in Economics Research Network (Havranek et al., 2020).
