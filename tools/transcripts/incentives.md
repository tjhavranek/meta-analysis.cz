...
^{*} Corresponding author: Zuzana Irsova, irsova.com. Contact email: zuzana.irsova@fsv.cuni.cz. Data and code are available in an online appendix at meta-analysis.cz/incentives. We thank Anna Dreber and Uri Gneezy for comments that helped us improve the paper substantially. Cala, Irsova, and Luskova acknowledge support from the Czech Science Foundation (grant no. 23-05227M). Havranek, Matousek, and Novak acknowledge support from the Czech Science Foundation (grant no. 24-11583S). Luskova acknowledges support from Charles University Research Centre program no. 24/SSH/020.
