...
FIGURE 3. Impulse responses of banking, debt, and currency crises.
Note: Solid lines show the impulse responses with the baseline ordering, shaded areas denote the corresponding 95% confidence intervals, and dashed lines display the mean impulse responses using the five alternative orderings.
...
FIGURE 4. The costs of banking, debt, and currency crises in terms of GDP loss (upper graphs) and cumulative GDP loss (lower graphs).
Note: Solid lines show the impulse responses with the baseline ordering, and shaded areas denote the 95% confidence intervals.
...
FIGURE 5. Bayesian model averaging: early warning indicators of banking crisis onset, horizon from 5 to 8 quarters.
...
FIGURE 6. Bayesian model averaging: early warning indicators of banking crisis onset, horizon from 9 to 12 quarters.
Note: Rows = potential early warning indicators. Columns = best models according to marginal likelihood, ordered from left. Full cell = variable included in model, blue = positive sign, red = negative sign. (For interpretation of the references to color in this figure legend, the reader is referred to the web version of the article.)
...
FIGURE 10. Policy makers’ trade-off between missed crises and false alarms.
...
FIGURE 11. Noise-to-signal ratio, loss function value, and usefulness.
Note: The noise-to-signal ratio and the value of the loss function are reported for the composite early warning indicator. Usefulness is reported for both the composite indicator and the single indicator of domestic private credit.
...
FIGURE I.4.1. Bayesian model averaging for limited dependent variable: early warning indicators of banking crisis onset, horizon within 5–8.
Note: We use the library BMA for R developed by Raftery et al., available at quarters: http://cran.r-project.org/web/packages/BMA/index.html.
