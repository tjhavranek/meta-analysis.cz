...
ALT 11. A line chart of the relative mean squared error of the price-level forecast against a forecast horizon of one to twelve months, one line per financial variable. After the first month the lines cluster tightly between about 0.8 and 1.1: loan loss provisions and credit sit below one from the third month on, while non-performing loans and liquidity sit just above it. The px index runs close to one throughout.
...
ALT A1. A line chart of relative mean squared error against a forecast horizon of one to four quarters. The px index and non-performing loans lie between about 0.5 and 0.9, liquidity just below one, credit between 1.2 and 1.5, and loan loss provisions highest, between about 1.55 and 2.45.
...
ALT A3. A line chart of relative mean squared error against a forecast horizon of one to four quarters, with the vertical axis running to five. The px index stays at or below one. Liquidity and non-performing loans start above the top of the axis and fall to about 1.1 and 1.6. Credit also starts off the axis and settles between 2.2 and 2.5. Loan loss provisions run near one.
FIGURE A3. Forecast performance compared to the purely macroeconomic model (1-year forecast of GDP, VAR 1999:1 - 2008:7)

### Prices

ALT A4. A line chart of relative mean squared error against a forecast horizon of one to twelve months. Loan loss provisions rise to about 3.3 in the second month and stay above two for the rest of the horizon. Liquidity, non-performing loans and the px index settle between about 0.6 and one, and credit runs just above one.
...
ALT A5. A line chart of relative mean squared error against a forecast horizon of one to twelve months. Loan loss provisions start near 0.2 and rise to about 0.75. Credit runs just under 0.9. The px index runs at about one. Liquidity falls from 1.4 towards one, and non-performing loans run between 1.1 and 1.3.
