...
FIGURE 2. The Effect of Euro Area and Exchange Rate Shocks on Czech GDP and Prices – Impulse Responses.
Note: Orthogonal impulse responses to one standard error shocks. Bootstrapped Hall (1988) 95% confidence intervals.
...
FIGURE 3. The Effect of Czech and Euro Area Monetary Policy on Czech GDP, Prices, and the Exchange Rate – Impulse Responses.
Note: Orthogonal impulse responses to one standard error shocks. Bootstrapped Hall (1988) 95% confidence intervals.
...
FIGURE 4. The Effect of Credit on Czech GDP and Prices and the Effect of Monetary Policy on Credit – Impulse Responses.
Note: Orthogonal impulse responses to one standard error shocks. Bootstrapped Hall (1988) 95% confidence intervals.
...
FIGURE 5. The Effect of Bank Liquidity on Czech GDP and Prices and the Effect of Monetary Policy on Bank Liquidity – Impulse Responses.
Note: Orthogonal impulse responses to one standard error shocks. Bootstrapped Hall (1988) 95% confidence intervals.
...
FIGURE 6. The Effect of Loan Loss Provisions on Czech GDP and Prices and the Effect of Monetary Policy on Loan Loss Provisions – Impulse Responses.
Note: Orthogonal impulse responses to one standard error shocks. Bootstrapped Hall (1988) 95% confidence intervals.
...
FIGURE 7. The Effect of Non-Performing Loans on Czech GDP and Prices and the Effect of Monetary Policy on Non-Performing Loans – Impulse Responses.
Note: Orthogonal impulse responses to one standard error shocks. Bootstrapped Hall (1988) 95% confidence intervals.
...
FIGURE 8. The Effect of the Stock Market on Czech GDP and Prices and the Effect of Monetary Policy on the Stock Market – Impulse Responses.
Note: Orthogonal impulse responses to one standard error shocks. Bootstrapped Hall (1988) 95% confidence intervals.
...
FIGURE 9. The Effect of the Stock Market on Czech GDP and Prices and the Effect of Monetary Policy on the Stock Market – Impulse Responses.
Note: Orthogonal impulse responses to one standard error shocks. Bootstrapped Hall (1988) 95% confidence intervals.
...
FIGURE 10. Do Financial Variables Improve the Forecast of GDP?
Note: The forecasting performance of the VAR models with individual financial variables is compared to that of the VAR model with macroeconomic variables only. Values of the relative mean square error below one indicate that the financial variable improves the forecasts of GDP.
...
FIGURE 11. Do Financial Variables Improve the Forecast of Prices?
Note: The forecasting performance of the VAR models with individual financial variables is compared to that of the VAR model with macroeconomic variables only. Values of the relative mean square error below one indicate that the financial variable improves the forecasts of prices.
