...
def build(check=False):
    ...
    caption = (
        ...
        'values that disagree with each other; three are out because the correction flips the '
        'sign, and a ratio of magnitudes across a sign flip would not mean what this figure '
        'means, and a literature that already has a dot does not get a second one. '
