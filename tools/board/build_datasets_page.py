...
<p>Slichter and Tran, who have no connection to this project, ask whether better journals
publish better estimates, and answer with 14,387 published estimates from 24 literatures. They
name three sources for those literatures, and this site is one of them: &#8220;a database of
meta-analyses operated by the Institute of Economic Studies at Charles University&#8221;, with
meta-analysis.cz in the footnote. <b>Eleven of their twenty-four literatures are datasets from
this page</b>, and those eleven supply 502 of the 871 primary studies in their sample. Their
finding is that within a literature the mean and variance of published estimates have little or
no correlation with journal rank: the chance that an estimate drawn from a top journal is closer
to the truth than one drawn from a mid-ranked journal is about 51%, a coin flip. The paper is
accepted at the <i>Journal of Political Economy Microeconomics</i>; until it appears there, it
is <a href="https://www.iza.org/publications/dp/17960">IZA Discussion Paper 17960</a>.</p>

<p>That is the use this collection is for. Pooling the estimates was worth doing if someone
outside the project can ask a question none of the original papers asked, and answer it from the
pooled table. The eleven literatures are tuition and enrolment, individual discount rates,
capital-labor substitution, the social cost of carbon, intertemporal substitution, skill
substitution, water demand, the Armington elasticity, excess sensitivity of consumption,
student employment, and the price elasticity of gasoline.</p>
