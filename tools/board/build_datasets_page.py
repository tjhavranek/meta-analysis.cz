...
<p>New to these files? The <a href="/datasets/example/"><b>worked example</b></a> goes from
download to a bias-corrected estimate on one literature in ten lines of code, with every
number on the page computed from the shipped data.</p>
