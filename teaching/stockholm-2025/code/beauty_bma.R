...
#  -------------------------------------------------------------
#  Example: "Beauty and Professional Success" (Bortnikova, Havranek, Bartos, Irsova)
#
...
#  markets. This script complements the Stata materials used in the Tillväxtanalys workshop.
#
# ------------------------------------------------------------------------------------------
#  Requirements (must be installed manually before the course begins):
#
#  Software:
