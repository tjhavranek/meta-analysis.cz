...
/******************************************************************************************
   ...
   Example: "Beauty and Professional Success" 
            (Bortnikova, Havranek, Bartos, Irsova)
   ...
   It is designed for instructional use in the Tillväxtanalys meta-analysis workshop
   and includes step-by-step annotations, modular structure, and code best practices.
   
   ----------------------------------------------------------------------------------------
   Requirements (install beforehand — workshop will be offline):
